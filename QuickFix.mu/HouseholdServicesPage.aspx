<%@ Page Title="Household Services" Language="C#" MasterPageFile="~/QuickFixMasterPage.Master" AutoEventWireup="true" CodeBehind="HouseholdServicesPage.aspx.cs" Inherits="QuickFix.mu.HouseholdServicesPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <header class="page-header" data-background="images/h1.jpg" data-stellar-background-ratio="1.15">
        <div class="container">
            <h1>Household Services</h1>
            <p>Discover trusted services for all your household needs.</p>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Start</a></li>
                <li class="breadcrumb-item active" aria-current="page">Household Services</li>
            </ol>
        </div>
    </header>
